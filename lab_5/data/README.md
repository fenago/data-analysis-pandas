...
| `fb_stock_prices_2018.csv` | Facebook stock's opening, high, low, and closing price daily, along with volume traded for 2018. | The `stock_analysis` package (see *Lab 7, Financial Analysis &ndash; Bitcoin and the Stock Market*). |
